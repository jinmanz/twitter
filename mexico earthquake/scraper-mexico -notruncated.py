...
# 你想查找的关键字
query = 'Mexico city'or'Mexico earthquake'
# 语言代码（遵循ISO 639-1标准）
language = 'en'
...
rows = []
i = 0
fo = open('tweets-27.txt', 'a')
#取1000条
while i < 10:
    results = api.search(q=query, lang=language, since='2017-09-27', until='2017-09-28',include_rts='true',count = 100)
...
with open('tweets-27.csv','a') as f:
    f_csv = csv.writer(f)
